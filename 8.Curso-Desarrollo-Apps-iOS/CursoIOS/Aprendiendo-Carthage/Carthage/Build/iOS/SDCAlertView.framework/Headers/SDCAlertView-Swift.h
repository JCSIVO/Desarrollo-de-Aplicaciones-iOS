...
#ifndef SDCALERTVIEW_SWIFT_H
#define SDCALERTVIEW_SWIFT_H
...
SWIFT_CLASS_NAMED("AlertAction") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS_NAMED("AlertController") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS_NAMED("AlertVisualStyle") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
@property (nonatomic, strong) UIColor * _Nullable actionViewCancelBackgroundColor;
...
/// The color for a preferred action’s text. If <code>nil</code>, <code>normalTextColor</code> is used.
@property (nonatomic, strong) UIColor * _Nullable preferredTextColor;
...
@property (nonatomic, strong) UIColor * _Nonnull dimmingColor;
